...
import 'package:tasnet/nearest_location.dart';

import 'bloc/main_provider.dart';
import 'bloc/nearest_location_bloc.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<NearestPlaceBloc>(
        bloc: NearestPlaceBloc(),
        child: MaterialApp(
          title: 'TasNet',
          theme: ThemeData(fontFamily: "Montserrat"),
          // home: FlotterTest(),
          home: NearestLocationsPage(
              // bloc: NearestPlaceBloc(),
              // home: NearestTestPage(),
              // home: LottieExample(),
              ),
        ));
  }
...
//         .loadAnimationFromAsset("assets/emoji_shock.json");
...
//         await instance.loadAnimationFromAsset("assets/star.json");
